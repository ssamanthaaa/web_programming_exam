...
//	private List<MainStage> MAIN_STAGES;
	...
	public Trip(Date DATE, String PLACE, int TRANSPORTATION, Document GEOJSON, int USER) {
		this.DATE = DATE;
		this.PLACE = PLACE;
...
//	}	
	...
	public String toString() {
		return "Trip: [ ID: " + ID + ", DATE: " + DATE + ". PLACE: " + PLACE + "TRANSPORTATION: " + TRANSPORTATION + "GEOJOSN: " + GEOJSON + " ]"; 
	}
}