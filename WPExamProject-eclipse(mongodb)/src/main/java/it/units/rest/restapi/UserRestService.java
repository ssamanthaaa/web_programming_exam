...
public class UserRestService extends ResourceConfig {
	...
	public Response authenticate( Credentials credentials ) {
		...
		try {
			String id = userDao.getUserIdByUsername( credentials.getUsername() );
...
//			return ResponseBuilder.createResponse( Response.Status.OK, map );
			...
			return Response.status(Response.Status.OK).entity(tokenJson).type(MediaType.APPLICATION_JSON).build();
		}
		catch( UserNotFoundException e ) {
