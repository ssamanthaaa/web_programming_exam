...
public class ResponseBuilder {
	...
	// list json
//	public static Response createResponse( Response.Status status, List<JsonObject> jsonList ) throws JSONException {
//		return Response.status( status ).entity( jsonList ).build();
//	}
